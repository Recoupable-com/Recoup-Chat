...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning className={GeistSans.variable}>
      <body className={`${GeistSans.variable} bg-white dark:bg-dark-bg-primary`}>
        <Suspense>
          <Providers>
            <div className="flex flex-col md:flex-row">
              ...
              <Header />
              <ArtistSettingModal />
              <div className="grow flex h-[100dvh] pt-16 md:pt-0 md:h-screen overflow-hidden md:bg-grey-light-3 dark:md:bg-dark-bg-secondary">
                <div className="size-full md:py-4 md:pl-4">
                  <div className="size-full bg-white dark:bg-dark-bg-primary overflow-y-auto md:rounded-xl flex flex-col md:shadow-[0px_0px_7px_0px_#80808063]">
                    {children}
                  </div>
                </div>
                <ArtistsSidebar />

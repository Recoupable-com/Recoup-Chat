...
import autoAssignAccountToOrg from "@/lib/organizations/autoAssignAccountToOrg";
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    if (email) {
      try {
        ...
        if (emailRecord?.account_id) {
          ...
          await autoAssignAccountToOrg(emailRecord.account_id, email);
    ...
    if (email) {
      ...
      // Auto-assign new account to org based on email domain
      await autoAssignAccountToOrg(newAccount.id, email);
    }

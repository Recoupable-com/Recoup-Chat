...
GRANT DELETE ON TABLE "public"."account_organization_ids" TO "anon";
GRANT INSERT ON TABLE "public"."account_organization_ids" TO "anon";
GRANT REFERENCES ON TABLE "public"."account_organization_ids" TO "anon";
GRANT SELECT ON TABLE "public"."account_organization_ids" TO "anon";
GRANT TRIGGER ON TABLE "public"."account_organization_ids" TO "anon";
GRANT TRUNCATE ON TABLE "public"."account_organization_ids" TO "anon";
GRANT UPDATE ON TABLE "public"."account_organization_ids" TO "anon";

GRANT DELETE ON TABLE "public"."account_organization_ids" TO "authenticated";
GRANT INSERT ON TABLE "public"."account_organization_ids" TO "authenticated";
GRANT REFERENCES ON TABLE "public"."account_organization_ids" TO "authenticated";
GRANT SELECT ON TABLE "public"."account_organization_ids" TO "authenticated";
GRANT TRIGGER ON TABLE "public"."account_organization_ids" TO "authenticated";
GRANT TRUNCATE ON TABLE "public"."account_organization_ids" TO "authenticated";
GRANT UPDATE ON TABLE "public"."account_organization_ids" TO "authenticated";

GRANT DELETE ON TABLE "public"."account_organization_ids" TO "service_role";
GRANT INSERT ON TABLE "public"."account_organization_ids" TO "service_role";
GRANT REFERENCES ON TABLE "public"."account_organization_ids" TO "service_role";
GRANT SELECT ON TABLE "public"."account_organization_ids" TO "service_role";
GRANT TRIGGER ON TABLE "public"."account_organization_ids" TO "service_role";
GRANT TRUNCATE ON TABLE "public"."account_organization_ids" TO "service_role";
GRANT UPDATE ON TABLE "public"."account_organization_ids" TO "service_role";

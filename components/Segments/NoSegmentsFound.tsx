  ...
  return (
    <div className="text-lg text-center py-8 flex flex-col items-center gap-4 dark:text-white">
      ...
      <ul className="mb-4 text-left w-full max-w-xs">
        <li className="flex items-center space-x-3 p-2 rounded bg-gray-50 dark:bg-dark-bg-tertiary border border-gray-200 dark:border-dark-border-light my-1 text-gray-800 dark:text-gray-200">
        ...
        {[
          ...
          <li
            key={item}
            className="flex items-center space-x-3 p-2 rounded bg-gray-50 dark:bg-dark-bg-tertiary border border-gray-200 dark:border-dark-border-light my-1 text-gray-800 dark:text-gray-200"
          >
            <Icons.UncheckedIcon />

...
const YouTubeSetThumbnailSkeleton = () => (
  <div className="flex flex-col items-center rounded-xl border border-gray-100 dark:border-dark-border p-4 max-w-xs mr-auto">
    <div className="w-full aspect-video mb-3 overflow-hidden rounded-lg bg-gray-200 dark:bg-dark-bg-tertiary animate-pulse" />
    <div className="h-4 w-32 bg-gray-200 dark:bg-dark-bg-tertiary rounded mb-2 animate-pulse mr-auto"  />

...
const YouTubeSetThumbnailSkeleton = () => (
  <div className="flex flex-col items-center rounded-xl border border-border  p-4 max-w-xs mr-auto">
    ...
    <div className="h-3 w-24 bg-muted  rounded animate-pulse mr-auto" />
  </div>
);

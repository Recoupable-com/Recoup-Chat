      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
        {skeletonItems.map((item) => (
          <Card key={item} className="overflow-hidden border-0 bg-transparent rounded-xl h-full">
            <div className="relative aspect-square w-full overflow-hidden rounded-xl bg-gray-200 dark:bg-dark-bg-tertiary animate-pulse"></div>
            <CardContent className="p-3">
              <div className="h-4 bg-gray-200 dark:bg-dark-bg-tertiary rounded-md animate-pulse w-3/4 mb-2"></div>
              <div className="h-3 bg-gray-200 dark:bg-dark-bg-tertiary rounded-md animate-pulse w-1/2"></div>
            </CardContent>
          </Card>
        ))}
      </div>
